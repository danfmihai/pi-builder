...
#REPO_URL ?= http://mirror.yandex.ru/archlinux-arm #http://de3.mirror.archlinuxarm.org
...
_QEMU_STATIC_BASE_URL = http://us.debian.org/debian/pool/main/q/qemu		#http://mirror.yandex.ru/debian/pool/main/q/qemu
